...
<body>
  ...
  <a href="${contextPath}/test?name=이태용&age=31">기존방식(url 직접 작성)</a> <br>

  <!-- c:url은 자동으로 앞에 contextPath를 붙여줌 -->
  <a href="<c:url value="/test?name=이태용&age=31"/>">c:url 바로 사용하는 방식</a>

  <c:url var="tyurl" value="/test">
    <c:param name="name" value="이태용"/>
    <:param name="age" value="31"/>
  </c:url>
  <!-- tyurl = "/test?name=이태용&age=31" -->

  <a href="${tyurl}">c:url로 만들어둔 걸 사용하는 방식</a>
