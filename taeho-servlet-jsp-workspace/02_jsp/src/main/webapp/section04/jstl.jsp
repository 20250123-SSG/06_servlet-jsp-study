...
<h3> 1. 변수 (== JSP내장 객체의 attribute) </h3>
...
<h3>4. url 제작</h3>
  <a href="${contextPath}/test?name=홍길동&age=10">기존방식 (url 직접작성)</a>
  ...
  <!-- mkurl = /test?name=홍&age=10 -->

  <a href="${mkurl}">c:url로 만들어준 걸 사용하는 방식</a>
