...
num1값(그냥출력) : ${ num1 } <br>
num1값(구분자 유) : <fmt:formatNumber value="${ num1 }"/> <br>

num2값(백분율) : <fmt:formatNumber value="${ num2 }" type="percent"/> <br>

num3값(원화 통화기호, 구분자 무) : <fmt:formatNumber value="${ num3 }" type="currency" groupingUsed="false"/> <br>
num3값(달러 통화기호, 구분자 유) : <fmt:formatNumber value="${ num3 }" type="currency" currencySymbol="$"/> <br><br>
...
<ul>
  ...
  <li>둘 다 : <fmt:formatDate value="${ current }" type="both"/></li> <!-- dateStyle, timeStyle 생략시 기본값이 medium -->
...
<!-- arrayList또는 배열도 제시가능함 => 리스트 또는 배열의 사이즈 -->
