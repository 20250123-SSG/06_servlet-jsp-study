...
<%--
  ...
  <%@ page import="com.kangbroo.jsp.dto.PersonDto" %>
  <%
  ...
  <p>
    ...
    학생정보 : <%=stu.getName()%>, <%=stu.getAge()%>, <%=stu.getGender()%>
  </p>
--%>
...
<!-- el내에서 산술연산자 작성시 피연산자들을 무조건 숫자형으로 형변환해서 처리함-->

<h5>* 유의사항 : 문자열을 연이주고자 할 때 + 연산 사용 불가!</h5>
<%-- ${str1 + str3} => NumberFormatException 발생 --%>
해결방법 : ${str1}${str3}
